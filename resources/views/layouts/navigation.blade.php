<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Ruta personalizada hacia home, la ruta se usa el nombre -->
                    <x-nav-link :href="route('users.index')" :active="request()->routeIs('users.index')">
                        Usuario
                    </x-nav-link>
                    <!-- Ruta personalizada hacia contactos -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('HomeAlabama')" :active="request()->routeIs('HomeAlabama')">
                {{ __('HomeAlabama') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('contactos.index')" :active="request()->routeIs('contactos.index')">
                {{ __('Contactos') }}
            </x-responsive-nav-link>
